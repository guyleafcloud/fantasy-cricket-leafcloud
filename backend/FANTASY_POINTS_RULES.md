...
**Example:**
- 85 runs off 46 balls = SR 184.8 → **+10 points bonus**
- 45 runs off 100 balls = SR 45.0 → **-5 points penalty**
...
**Example:**
- 2/18 in 6 overs = ER 3.0 → **+10 points bonus**
- 1/40 in 5 overs = ER 8.0 → **-5 points penalty**
...
Maidens:           125 points (5 x 25) ← HUGE!
...
## 🔄 What Changed from Old Rules

### ❌ Removed
- **Fours bonus:** Was 1 point per four → Now 0
- **Sixes bonus:** Was 2 points per six → Now 0

### ⬆️ Increased
- **Maidens:** 4 points → **25 points** (6.25x increase!)
...
1. **No minimum requirements** for SR/ER bonuses
   - Even 1 ball faced → SR calculation
   - Even 1 over bowled → ER calculation
