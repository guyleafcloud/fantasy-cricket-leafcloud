  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <button
              ...
              className="p-6 bg-white border-2 border-cricket-green rounded-lg hover:bg-green-50 text-left transition-colors"
            >
              <div className="text-cricket-green font-semibold mb-2">Browse Leagues</div>
              <div className="text-sm text-gray-600">Find and join public leagues</div>
            </button>
            <button
              onClick={() => setShowJoinModal(true)}
              className="p-6 bg-white border-2 border-blue-500 rounded-lg hover:bg-blue-50 text-left transition-colors"
            >
              <div className="text-blue-600 font-semibold mb-2">Join with Code</div>
              <div className="text-sm text-gray-600">Enter a league invite code</div>
            </button>
            <button
              onClick={() => router.push('/teams')}
              className="p-6 bg-white border-2 border-purple-500 rounded-lg hover:bg-purple-50 text-left transition-colors"
            >
              <div className="text-purple-600 font-semibold mb-2">My Teams</div>
              <div className="text-sm text-gray-600">View and manage your teams</div>
            </button>
            <button
              onClick={() => router.push('/how-to-play')}
              className="p-6 bg-white border-2 border-orange-500 rounded-lg hover:bg-orange-50 text-left transition-colors"
            >
              <div className="text-orange-600 font-semibold mb-2">📖 How to Play</div>
              <div className="text-sm text-gray-600">Learn scoring rules & strategy</div>
            </button>
          </div>
        </div>
        ...
        {/* My Leagues Section */}
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">My Leagues</h2>
              ...
              <div className="space-y-4 mb-4">
                <div>
                  ...
                  <input
                    type="text"
                    required
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-cricket-green focus:border-transparent uppercase"
                ...
                <div>
                  ...
                  <input
                    type="text"
                    required
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-cricket-green focus:border-transparent"
